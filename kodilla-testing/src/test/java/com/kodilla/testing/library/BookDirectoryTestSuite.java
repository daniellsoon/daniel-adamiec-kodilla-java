...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHands() {
        ...
        LibraryUser user1 = new LibraryUser("Jan" , "Kowalski" , "123456789");
        LibraryUser user2 = new LibraryUser("Janko" , "Kowal" , "987654321");
        LibraryUser user3 = new LibraryUser("Janina" , "Kowal" , "741852963");
